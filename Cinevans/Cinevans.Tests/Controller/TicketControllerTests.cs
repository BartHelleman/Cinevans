...
namespace Cinevans.Tests.Controller {
    ...
    public class TicketControllerTests {
        ...
        public void GetOrderView() {
            //act
            ViewResult result = (ViewResult)ticketController.Order();

            //assert
            Assert.AreEqual("Order", result.ViewName);
        }*/
        [TestMethod]
        public void generateTicketPrintFriendly() {
            try {
                //assemble
        ...
        [TestMethod]
        public void generateTicketNotPrintFriendly() {
            try {
                //assemble
                List<Ticket> ticketList = new List<Ticket>();
                ticketList.Add(new Ticket { TicketId = 1, SeatId = 1, ViewingId = 1, RateId = 1, Rate = new Rate { RateId = 1, Name = "Testrate", Price = 8 }, Seat = new Seat { SeatId = 1, IsTaken = false, Row = new Row { RowNumber = 1 }, }, Viewing = new Viewing { Movie = new Movie { Titel = "MovieTitel" }, StartTime = DateTime.Now, Room = new Room { RoomId = 1 } } });
        ...
        public void getIntList() {
            ...
            expectedArray.Add(1);
            expectedArray.Add(5);
            expectedArray.ToArray();
            //act
            List<int> result = ticketController.GetIntList(15);
            //assert
            Assert.AreEqual(expectedArray.Count, result.Count);
        ...
        */
        ...
        [TestMethod]
        public void DownloadTicketsTest()
        {
